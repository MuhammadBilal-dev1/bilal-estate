    ...
    <div>
      ...
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 ">
          Bilal Estate is the best place to find your next perfect place to
          live.
          <br />
      ...
      {/* listing results for offer, sle and rent */}
        ...
        {saleListings && saleListings.length > 0 && (
          <div className="mx-auto">
            <div className="my-3">
              ...
              <Link className="text-blue-800 hover:underline" to={"/search?type=sale"}>Show more places for sale</Link>
            </div>
            <div className="flex flex-wrap gap-4">
